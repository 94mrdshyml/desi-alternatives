...
export const GET: APIRoute = async ({ params, locals }) => {
  ...
  try {
    ...
    console.error('Error rendering OG alternative banner:', e);
  }
  ...
  <style>
    ...
    .subcard-title { font-family: 'Instrument Sans', system-ui, -apple-system, sans-serif; font-weight: 700; font-size: 20px; fill: #FFFFFF; }
    .subcard-sub { font-family: 'Instrument Sans', system-ui, -apple-system, sans-serif; font-weight: 400; font-size: 13px; fill: #94A3B8; }
    .subcard-price { font-family: 'Instrument Sans', system-ui, -apple-system, sans-serif; font-weight: 700; font-size: 14px; fill: #34D399; }
  ...
  <g transform="translate(100, 95)">
    ...
    <text x="155" y="24" text-anchor="middle" class="kicker">🇮🇳 SOVEREIGN SAAS DIRECTORY</text>

    <rect x="670" y="0" width="210" height="38" rx="19" fill="#450A0A" stroke="#DC2626" stroke-width="1.5" />
    <text x="775" y="24" text-anchor="middle" class="badge-text" font-size="14" fill="#FCA5A5">Foreign USD: ${usdPrice}</text>
  </g>
